...
import { SettingsAdjust, ChevronDown, Copy, TrashCan } from "@carbon/icons-react";
...
const ConstraintBox: React.FC<ConstraintBoxProps> = ({ constraint, isFreeFloating, onDuplicate, onDelete }) => {
	...
	return (
		<ContextMenu>
			...
			<ContextMenuContent>
				<ContextMenuLabel>{constraint.key || "Constraint"}</ContextMenuLabel>
